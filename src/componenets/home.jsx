...
function Home() {
  ...
  const images = [`${process.env.PUBLIC_URL}/images/image 19.png`];
  ...
  const faqs = [
    {
      ...
      answer:
        "Absolutely! We provide comprehensive coverage of your wedding day, capturing every moment from preparations to the reception.",
    },
    {
      question: "Do You Offer Engagement Photo Sessions?",
      answer:
        "Yes, we offer engagement sessions that allow you to capture beautiful moments before your wedding, providing a great way to get comfortable in front of the camera.",
    },
    {
      question:
        "How Do You Handle Different Lighting Conditions During The Wedding?",
      answer:
        "We are experienced in working with various lighting conditions, including natural light and indoor venues, ensuring that every photo looks stunning regardless of the environment.",
    },
    {
      question: "Can We Customize Our Wedding Photography Package?",
      answer:
        "Definitely! We offer customizable packages to fit your specific needs, including options for hours of coverage, number of photographers, and additional services.",
    },
    {
      question: "How Many Photos Will We Receive From Our Wedding?",
      answer:
        "The number of photos varies by package, but you can expect to receive hundreds of beautifully edited images that capture the essence of your day.",
    },
    {
      question: "When Will We Receive Our Wedding Photos?",
      answer:
        "Typically, you will receive your edited wedding photos within 4-6 weeks after your wedding day, depending on the season and our current schedule.",
    },
    {
      question: "Do You Provide Wedding Albums?",
      answer:
        "Yes, we offer high-quality wedding albums that beautifully showcase your favorite images from the day, designed to last a lifetime.",
    },
    {
      question: "Can You Help Us With A Wedding Photography Timeline?",
      answer:
        "Absolutely! We can assist in creating a photography timeline that ensures we capture all the key moments of your wedding day.",
    },
  ];
  ...
  return (
    <div>
      <div className="relative w-full h-screen flex hero object-cover object-center p-4">
        ...
        <div
          className="inset-x-0 top-[20%] mx-auto text-center p-4"
          style={{ fontFamily: "Raleway", lineHeight: "78px" }}
        >
          <div className="flex flex-col items-center">
            ...
            >
              SOM
              <span className="inline-block mx-2">SHARMA</span>
            </h1>
      ...
      <div className="text-white py-4 mt-10">
        ...
        <div className="flex justify-center">
          <button
            className="w-[98px] lg:w-[233px] lg:h-[74px] border border-[#FCFC04] text-center text-lg font-semibold text-[#FCFC04] bg-transparent hover:bg-[#FCFC04] hover:text-black transition-colors my-20"
            onClick={() => {
              navigate("/portfolio");
  ...
  "
      ...
      <div className="max-w-6xl mx-auto pt-10 px-4">
        {faqs.slice(0, seeAll ? faqs.length : 4).map((faq, index) => (
          <div
            key={index}
            className="border border-gray-600 mb-4 rounded-md overflow-hidden"
          >
            <div
